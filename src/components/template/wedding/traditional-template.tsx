export default function TraditionalCeremony({}) {
  const ceremonies = [
    {
      name: "ពិធីកាត់សក់",
    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white rounded-3xl shadow-2xl p-8">
            ...
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="khmer-font text-2xl font-bold text-red-700">
                    {ceremony.name}
                  </h3>
                  ...
                  <p className="khmer-font text-gray-600">
        ...
        <div className="mt-8 bg-red-100 rounded-2xl p-6 text-center">
          <h3 className="khmer-font text-2xl font-bold text-red-800 mb-4">
            ការណែនាំសម្រាប់ភ្ញៀវ
          </h3>
          ...
          <ul className="text-left max-w-2xl mx-auto space-y-2">
            <li className="flex items-start">
              ...
              <span>
                សូមស្លៀកពាក់ឱ្យបានសមរម្យ តាមប្រពៃណី (Please dress modestly and
                traditionally)
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-red-500 mr-2">•</span>
              <span>
                សូមទទួលទានអាហារ និងភេសជ្ជៈដែលបានរៀបចំ (Please enjoy the food and
                drinks provided)
              </span>
            </li>
            <li className="flex items-start">
              <span className="text-red-500 mr-2">•</span>
              <span>
                ការថតរូប នឹងអនុញ្ញាតក្នុងសមយុទ្ធផល (Photography allowed at
                appropriate times)
              </span>
            </li>
          </ul>
