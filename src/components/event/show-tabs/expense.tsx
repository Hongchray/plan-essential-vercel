...
export default function TabExpense({expenses, setExpenses}: {expenses: any[], setExpenses: (expenses: any[]) => void}) {
  // Expense Component
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          {expenses.map(expense => (
            <div key={expense.id} className="flex items-start justify-between p-4 border border-slate-200 rounded-lg">
