...
export function formatDate(date: string | number | Date, format = 'medium') {
  ...
  return d.toLocaleDateString('en-US', options[format as keyof typeof options] as Intl.DateTimeFormatOptions)
}
 ...
 */
export function formatTime(date: string | number | Date, includeSeconds = false) {
  if (!date) return ''
 ...
 */
export function formatDateTime(date: string | number | Date, dateFormat = 'short', includeSeconds = false) {
  if (!date) return ''
  ...
  const formattedDate = d.toLocaleDateString('en-US', dateOptions[dateFormat as keyof typeof dateOptions] as Intl.DateTimeFormatOptions)
  const formattedTime = d.toLocaleTimeString('en-US', timeOptions as Intl.DateTimeFormatOptions)
 ...
 * @returns {string} Formatted date string
 */
export function formatDateCustom(date: string | number | Date, pattern = 'YYYY-MM-DD') {
  if (!date) return ''
